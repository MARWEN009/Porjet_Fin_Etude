...
String FIREBASE_HOST = "https://esp32-data-27fbf-default-rtdb.firebaseio.com/";
String FIREBASE_AUTH = "eN2Dj2xZDJJlkbODmYelZ2jqRdVw41XYDf0J5ixs";
...
void loop() { 
  ...
  if (Firebase.setString(firebaseData, photoPath, jsonData)) {
